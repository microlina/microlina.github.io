...
V = Vectorizer = (function() {
    ...
    // of markers. The easiest way of understand on what this does is to imagine the element is an
...
joint.dia.CellView = joint.mvc.View.extend({
    ...
    getSelector: function(el, prevSelector) {
        ...
        if (el) {
            ...
            var nthChild = V(el).index2html() + 1;
...
(function(joint, util, V, g) {
    ...
    var Vertices = ToolView.extend({
        ...
        onHandleChanging: function(handle, evt) {
            ...
            var index = handle.options.index2html;
    ...
    var Segments = ToolView.extend({
        ...
        onHandleChanging: function(handle, evt) {
            ...
            var relatedView = this.relatedView;
            var paper = relatedView.paper;
            var index = handle.options.index2html - 1;
            var normalizedEvent = util.normalizeEvent(evt);
