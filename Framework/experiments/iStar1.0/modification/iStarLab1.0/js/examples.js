...
istar.examples.hotel = {
    "actors": [
        {
            ...
            "nodes": [
                ...
                {
                    "id": "321e6411-3f38-446b-be7b-c8cd1ca5bf5d",
                    "text": "Book room",
                    "type": "istar.Task",
                    "x": 178,
                    "y": 167,
        ...
        },
        {
            ...
            "nodes": [
                ...
                {
                    "id": "59910a72-550f-4b6e-bab1-b5d00bc9f5f6",
                    "text": "Manage possible booking",
                    "type": "istar.Task",
                    "x": 581,
                    "y": 165,
                    "customProperties": {
                ...
                {
                    "id": "da5410ae-6861-43ab-ab03-64c0bbe4f028",
                    "text": "Manage confirmed booking",
                    "type": "istar.Task",
                    "x": 729,
                    "y": 167,
                    "customProperties": {
    ...
    "links": [
        {
            "id": "260b6ec5-1351-497c-87f9-57c8886b0e2f",
            "type": "istar.DependencyLink",
            "source": "ac4a596e-d71e-4280-8546-2399670d8886",
            "target": "5744b233-e196-47e6-bde2-490876b7aea7"
        },
        {
            "id": "0026dca7-8fc2-4096-8cd6-ee6bb389c40d",
            "type": "istar.DependencyLink",
            "source": "5744b233-e196-47e6-bde2-490876b7aea7",
            "target": "19f856b1-e8d1-4557-9b51-12cfc811059e"
        },
        {
            "id": "6ca7241e-6af3-45fb-a480-37d8765e4bf3",
            "type": "istar.DependencyLink",
            "source": "c0c85e96-0340-4808-bf1b-8c49364745e5",
            "target": "f5fb3997-2f10-4837-b2a3-f90a0fd5afea"
        },
        {
            "id": "611a5991-c161-419c-a329-a725dfc99d89",
            "type": "istar.DependencyLink",
            "source": "f5fb3997-2f10-4837-b2a3-f90a0fd5afea",
            "target": "b3692090-0178-4809-a2aa-f7953c782a5f"
        },
        {
            "id": "b7c1701a-0bc8-41f5-b0c1-824ff512b4c0",
            "type": "istar.MeansEndsLink",
            "source": "321e6411-3f38-446b-be7b-c8cd1ca5bf5d",
            "target": "971c8ad6-7202-4e3f-b58c-a87fa1ae5138"
        },
        {
            "id": "a7348a51-a6fa-4c5f-91b6-c441aca586da",
            "type": "istar.DecompositionLink",
            "source": "19f856b1-e8d1-4557-9b51-12cfc811059e",
            "target": "321e6411-3f38-446b-be7b-c8cd1ca5bf5d"
        },
        {
            "id": "e8def132-748e-4e6a-b762-f25fad31fb89",
            "type": "istar.DecompositionLink",
            "source": "c0c85e96-0340-4808-bf1b-8c49364745e5",
            "target": "321e6411-3f38-446b-be7b-c8cd1ca5bf5d"
        },
        {
            "id": "b1b864cc-86b2-462b-9220-65d4bc1b573c",
            "type": "istar.DecompositionLink",
            "source": "b3692090-0178-4809-a2aa-f7953c782a5f",
            "target": "59910a72-550f-4b6e-bab1-b5d00bc9f5f6"
        },
        {
            "id": "58ed7723-deb7-4f8d-8389-4da29a25bebd",
            "type": "istar.DecompositionLink",
            "source": "ac4a596e-d71e-4280-8546-2399670d8886",
            "target": "da5410ae-6861-43ab-ab03-64c0bbe4f028"
        },
        {
            "id": "c1364a01-a4e2-4147-b9cd-08df4ed20940",
            "type": "istar.MeansEndsLink",
            "source": "59910a72-550f-4b6e-bab1-b5d00bc9f5f6",
            "target": "ea007ffe-3e6f-4f23-bfaa-b5f62bc7e844"
        },
        {
            "id": "2ce319f2-0cd9-4b79-b928-4491e83ddc32",
            "type": "istar.MeansEndsLink",
            "source": "da5410ae-6861-43ab-ab03-64c0bbe4f028",
            "target": "ea007ffe-3e6f-4f23-bfaa-b5f62bc7e844"
        }
    ],
    "display": {
        "260b6ec5-1351-497c-87f9-57c8886b0e2f": {
            "vertices": [
                {
                    "x": 727,
                    "y": 362
        ...
        "0026dca7-8fc2-4096-8cd6-ee6bb389c40d": {
            "vertices": [
                {
                    "x": 185,
                    "y": 367
    ...
    "tool": "istar.2.0.0a",
    "istar": "2.0",
    "saveDate": "Wed, 22 May 2019 14:06:36 GMT",
    "diagram": {
        "width": 1700,
        "height": 1300,
        "customProperties": {
